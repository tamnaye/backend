...
////        PrincipalDetails principalDetails = principalDetailsService.loadUserByUsername(userId);
////        if(principalDetails != null){
////           String accessToken = jwtProvider.createAccessToken(principalDetails.getUsername(), principalDetails.getAuthorities().toString());
////           String refreshToken = jwtProvider.createRefreshToken(principalDetails.getUsername());
////            response.setHeader(AUTHORIZATION_HEADER, accessToken);
////            response.addHeader(REAUTHORIZATION_HEADER, refreshToken);
////        }
////        return getAuthenticationManager().authenticate(new UsernamePasswordAuthenticationToken(userId, null, principalDetails.getAuthorities()));
//    }
//}
